...
public class Camera2Activity extends Activity implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            handler.post(new ImageSaver(Camera2Activity.this, reader.acquireNextImage(), isBack, handler));
        }
    };
    ...
    private void unlockFocus() {
        try {
            ...
            mCaptureSession.setRepeatingRequest(mPreviewRequest, mCaptureCallback, handler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
...
//                                setAutoFlash(mPreviewRequestBuilder);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public ImageSaver(Context context, Image image, boolean isBack, Handler handler) {
        ...
        public void run() {
            ...
            try {
                ...
                ImageUtils.saveImageToFileAndCompress(context, bytes, fileName, 240);
